...
#set JAVA_OPTS=-Djavax.net.ssl.trustStore=D:\Autres\Developpement\Eclipse\luna-git-workspace\hometime\web\conf\keystore -Djavax.net.ssl.trustStorePassword=rafoufou %JAVA_OPTS%
