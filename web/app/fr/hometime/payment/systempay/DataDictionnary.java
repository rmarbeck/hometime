...
public class DataDictionnary {
	...
	public static final String PAYMENT_CARDS_VALUES_SEPARATOR = ";";
	public static final String PCVS = PAYMENT_CARDS_VALUES_SEPARATOR;
	
	public static final String PAYMENT_CARDS_DEFAULT = PAYMENT_CARDS_CB+PCVS+PAYMENT_CARDS_E_CB+PCVS+PAYMENT_CARDS_MAESTRO+PCVS+PAYMENT_CARDS_MASTERCARD+PCVS+PAYMENT_CARDS_VISA+PCVS+PAYMENT_CARDS_VISA_ELECTRON;
